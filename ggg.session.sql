...
-- DELETE FROM player WHERE player_id = 1 or player_id = 2

-- select * from player
-- select * from perk
-- select * from trinket

-- SELECT player_id, nickname, count_kill, sum_money FROM player ORDER BY count_kill
-- SELECT perk_id, name_perk, description_perk FROM perk
-- SELECT trinket_id, name_trinket, description_trinket FROM trinket
